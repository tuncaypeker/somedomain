namespace SomeDomain.Data.Infrastructure
{
    ...
    public class EntityBaseData<T> : IData<T> where T : ModelBase
    {
        ...
        SomeDomain.Infrastructure.Interfaces.ILogger<object> logger;
        private readonly IServiceScopeFactory _serviceScopeFactory;

        public EntityBaseData(SomeDomain.Infrastructure.Interfaces.ILogger<object> logger
